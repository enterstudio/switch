...
--
-- Host: localhost    Database: kamailio_db
-- ------------------------------------------------------
...
CREATE TABLE `topos_d` (
  ...
  `s_method` varchar(64) NOT NULL,
  `s_cseq` varchar(64) NOT NULL,
  `a_callid` varchar(255) NOT NULL,
  `a_uuid` varchar(255) NOT NULL,
  `b_uuid` varchar(255) NOT NULL,
  `a_contact` varchar(128) NOT NULL,
  `b_contact` varchar(128) NOT NULL,
  `as_contact` varchar(128) NOT NULL,
  `bs_contact` varchar(128) NOT NULL,
  ...
  `a_srcaddr` varchar(128) NOT NULL,
  `b_srcaddr` varchar(128) NOT NULL,
  `a_socket` varchar(128) NOT NULL,
  `b_socket` varchar(128) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `topos_t` (
  ...
  `x_vbranch` varchar(255) NOT NULL,
  `x_rr` mediumtext NOT NULL,
  `y_rr` mediumtext NOT NULL,
  `s_rr` mediumtext NOT NULL,
  `x_uri` varchar(128) NOT NULL,
  `a_contact` varchar(128) NOT NULL,
  `b_contact` varchar(128) NOT NULL,
  `as_contact` varchar(128) NOT NULL,
  `bs_contact` varchar(128) NOT NULL,
  `x_tag` varchar(255) NOT NULL,
  `a_tag` varchar(255) NOT NULL,
  `b_tag` varchar(255) NOT NULL,
  `a_srcaddr` varchar(128) NOT NULL,
  `b_srcaddr` varchar(128) NOT NULL,
