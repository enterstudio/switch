...
--
-- Current Database: `kamailio_db`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `kamailio_db` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `kamailio_db`;

GRANT ALL ON kamailio_db.* TO kamailio_user@'%' IDENTIFIED BY 'kamailiorw';
FLUSH PRIVILEGES;
...
INSERT INTO `location` VALUES (16,'uloc-57d237ed-6a1-61','phoneb',NULL,'sip:phoneB@10.128.19.231:5061;line=7fed991d1a7fffe',NULL,NULL,'2016-09-20 10:35:09',-1.00,'1605557635',2120,'2016-09-20 09:35:09',0,0,'Linphone/3.6.1 (eXosip2/4.1.0)','udp:10.128.19.233:5060',NULL,NULL,0);
...
INSERT INTO `subscriber` VALUES (5,'phoneA','wtelecom.es','p4ssw0rd','','0722e7b74ff6fc7e3c440392970a6db5','01dbb348a9317510123a202c9709e8bd',NULL),(6,'phoneB','wtelecom.es','p4ssw0rd','','92b9a903ed51bcb3a46c836c6a43b403','b1a379fa0fb0ce41110c600edeeba841',NULL);
...
INSERT INTO `version` VALUES ('acc',5),('acc_cdrs',1),('active_watchers',11),('address',6),('aliases',6),('carrierfailureroute',2),('carrierroute',3),('carrier_name',1),('cpl',1),('dbaliases',1),('dialog',7),('dialog_vars',1),('dialplan',2),('dispatcher',4),('domain',2),('domainpolicy',2),('domain_attrs',1),('domain_name',1),('globalblacklist',1),('grp',2),('htable',2),('imc_members',1),('imc_rooms',1),('lcr_gw',3),('lcr_rule',2),('lcr_rule_target',1),('location',6),('location_attrs',1),('missed_calls',4),('mohqcalls',1),('mohqueues',1),('mtree',1),('mtrees',2),('pdt',1),('pl_pipes',1),('presentity',3),('pua',7),('purplemap',1),('re_grp',1),('rls_presentity',1),('rls_watchers',3),('rtpproxy',1),('sca_subscriptions',1),('silo',7),('sip_trace',3),('speed_dial',2),('subscriber',6),('trusted',5),('uacreg',1),('uid_credentials',7),('uid_domain',2),('uid_domain_attrs',1),('uid_global_attrs',1),('uid_uri',3),('uid_uri_attrs',2),('uid_user_attrs',3),('uri',1),('userblacklist',1),('usr_preferences',2),('watchers',3),('xcap',4);
...
-- Dump completed on 2016-09-20  9:50:22
